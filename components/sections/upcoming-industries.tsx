            ...
            return (
              ...
              >
                <CardHeader className="pb-4 text-center">
                  <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-500 to-green-500 rounded-2xl mb-4 group-hover:animate-float shadow-lg mx-auto">
                    <IconComponent className="h-8 w-8 text-white" size={32} />
                  </div>
