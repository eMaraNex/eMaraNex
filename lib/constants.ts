...
export const SAAS_PRODUCTS: SaaSProduct[] = [
  {
    ...
    icon: "🐰",
    stats: { subscribers: "2.5K+", retention: "98%" },
    cta: "Start Free Trial",
    keywords: ["rabbit breeding software", "rabbit farm management", "livestock tracking", "breeding records"],
  },
  {
    ...
    icon: "🌸",
    stats: { subscribers: "1.8K+", retention: "96%" },
    cta: "Try Free for 14 Days",
    keywords: ["cosmetics business management", "beauty inventory software", "fragrance business", "batch tracking"],
  },
  {
    name: "Zao",
    description:
    ...
    icon: "🌾",
    stats: { subscribers: "3.2K+", retention: "97%" },
    cta: "Start 30-Day Trial",
    keywords: ["farm management software", "agricultural SaaS", "crop management", "livestock tracking"],
  },
  {
    name: "RetailFlow",
    description:
    ...
    icon: "🛍️",
    stats: { subscribers: "4.1K+", retention: "95%" },
    cta: "Get Started Today",
    keywords: ["retail management SaaS", "SME solutions", "inventory sync", "business analytics"],
  },
]
